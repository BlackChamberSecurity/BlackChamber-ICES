...
**Important:** You must also set the WebUI admin credentials in `.env`:

```env
WEBUI_ADMIN_USER=your-admin-user
...
Open [http://localhost:8090](http://localhost:8090) and log in with the admin credentials you set in `.env`.
